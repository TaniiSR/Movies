package com.task.movies.utils.uikit.toolbarview
...
import com.task.movies.databinding.LayoutToolbarViewBinding
...
class ToolBarView @JvmOverloads constructor(
    ...
    private var titleTextMarginStart: Int = 0
    ...
    init {
        ...
        attrs?.let {
            ...
            titleTextMarginStart = typedArray.getDimensionPixelSize(
                R.styleable.ToolbarView_tbTitleMarginStart,
                0
            )
    ...
    var tbTitleMarginStart: Int? = null
        set(value) {
            field = value
            tbTitleMarginStart?.let {
                titleTextMarginStart = it
                setTitleStartMargin()
            }
        }
    ...
    private fun setStartIconVisibility() {
        viewBinding?.ivLeftIcon?.visibility =
            if (startIconVisibility) View.VISIBLE else View.GONE
    }
    ...
    private fun setTitleStartMargin() {
        val layout: ConstraintLayout.LayoutParams =
            viewBinding?.toolbarTitle?.layoutParams as ConstraintLayout.LayoutParams
        layout.setMargins(titleTextMarginStart, 0, 0, 0)
        viewBinding?.toolbarTitle?.layoutParams = layout
    }
