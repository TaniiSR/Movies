...
import com.task.movies.data.remote.baseclient.erros.ApiError
import com.task.movies.data.remote.baseclient.erros.ServerError
import com.task.movies.data.remote.baseclient.interfaces.IRepository
import com.task.movies.data.remote.baseclient.sealed.NetworkErrors
...
abstract class BaseRepository : IRepository {
    ...
    private fun <T : BaseApiResponse> detectError(response: Response<T>): ApiError {
